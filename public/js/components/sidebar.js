...
window.Sidebar = {
  ...
  _sections: [
    ...
    { title: 'Operations', items: [
      ...
      { route: 'packing-master', label: 'Packing Master', icon: 'packingmaster', adminOnly: true },
    ]},
